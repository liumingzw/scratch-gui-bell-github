...
export default function (Blockly) {
    ...
    inherits(Blockly.TouchGesture, Blockly.Gesture);
    ...
    Blockly.TouchGesture.prototype.handleTouchStart = function (e) {
        ...
        if (pointers.length == 2) {
            ...
            this.startDistance_ = Math.sqrt(Math.pow(point0.x - point1.x, 2) + Math.pow(point0.y - point1.y, 2));//goog.math.Coordinate.distance(point0, point1);
    ...
    Blockly.TouchGesture.prototype.handleTouchMove = function (e) {
        ...
        if (pointers.length == 2) {
            ...
            var point0 = this.cachedPoints_[pointers[0]];
            var point1 = this.cachedPoints_[pointers[1]];
            var moveDistance = Math.sqrt(Math.pow(point0.x - point1.x, 2) + Math.pow(point0.y - point1.y, 2));//goog.math.Coordinate.distance(point0, point1);
